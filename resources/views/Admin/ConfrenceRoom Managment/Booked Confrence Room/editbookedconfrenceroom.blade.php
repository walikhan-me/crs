...
<div class="pagetitle">
  <h1>Edit Confrenceroom Management</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="">Edit Booked Confrence Room</a></li>
      <li class="breadcrumb-item">Edit Booked Confrenceroom</li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h3 class="card-title">Edit Booked Confrence Room</h3>
                <div class="col-8">
                ...
                <form id="participants-form" class="row g-3" enctype="multipart/form-data" method="POST" action="/create_bookedconfrenceroom">
                    ...
                    <div class="col-8">
                        ...
                        <ul id="employee_results">
                            @foreach(json_decode($editbookedconfrenceroom->participant_names) as $participant)
                                <li>{{ $participant }}</li>
                            @endforeach
                        </ul>
                        <ul id="selected_participants">
                        
                        </ul>
                        <input type="hidden" id="selected_employee_id" name="selected_employee_ids[]" >
                        <input type="hidden" id="selected_employee_name" name="selected_employee_names[]" value="{{$editbookedconfrenceroom->participant_names}}">
                        @foreach(json_decode($editbookedconfrenceroom->participant_emails) as $participantEmail)
                            <input type="hidden" name="selected_employee_emails[]" value="{{ $participantEmail }}">
                        @endforeach                   
                    </div>

                    <div class="col-8">
                        <label for="confrenece_room" class="form-label">User Name</label>
                        <input type="text" class="form-control" name="username" value="{{$editbookedconfrenceroom->username}}">
                    ...
                    <div class="col-8">
                        ...
                        <input type="text" class="form-control" name="user_id" value="{{$editbookedconfrenceroom->user_id}}">
                    ...
                    <div class="col-8">
                        ...
                        <input type="text" class="form-control" name="user_email" value="{{$editbookedconfrenceroom->user_email}}">
                    ...
                    <div class="form-floating mb-3 col-8">
                        <select class="form-select" id="conference_room" name="conference_room">
                            ...
                            @if($allConferenceRooms->count() > 0)
                                @foreach ($allConferenceRooms as $room)
                                    <option value="{{ $room->confrence_room }}" 
                                        @if($editbookedconfrenceroom && $editbookedconfrenceroom->conference_room == $room->id) 
                                            selected 
                                        @endif>
                                        {{ $room->confrence_room }}
                                    </option>
                                @endforeach
                            @else
                                <option value="" disabled>No Conference Rooms found</option>
                            @endif
                        </select>
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <input type="date" class="form-control" name="start_date" value="{{ $editbookedconfrenceroom->start_date }}">
                        ...
                        <div class="col-4">
                            ...
                            <input type="date" class="form-control" name="end_date" value="{{ $editbookedconfrenceroom->end_date }}">
                    ...
                    <div class="row">
                      <div class="col-4">
                          ...
                          <input type="time" class="form-control" name="start_time" value="{{ $editbookedconfrenceroom->start_time }}">
                      ...
                      <div class="col-4">
                          ...
                          <input type="time" class="form-control" name="end_time" value="{{ $editbookedconfrenceroom->end_time }}">
