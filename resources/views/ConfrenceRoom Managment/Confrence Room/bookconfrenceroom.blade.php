...
<div class="pagetitle">
  <h1>Confrence Room Managment</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="#">Confrence Room</a></li>
      <li class="breadcrumb-item">Add Confrence Room</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
<section class="section">
  <div class="row">
    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Book Confrence Room</h5>

          <form class="row g-3" enctype="multipart/form-data"  method='POST'  action='/book_confrence_room'>
             @csrf  
                <div class="col-8">
